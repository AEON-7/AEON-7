...
| [🎤 Voice AI Stack](#-voice-ai-stack) | Real-time speech on one DGX Spark — OpenAI-compatible TTS + ASR servers, Matrix VoIP bridge, AI persona builder. **~2.1 s end-to-end voice turns** |
